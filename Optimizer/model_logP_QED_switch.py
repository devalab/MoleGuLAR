...
parser.add_argument("--use_checkpoint", default='no', help="Load from a checkpoint")
...
PRED_FILE = f"{os.getenv('OPTIMIZER_DIR')}/predictions/{args.reward_function}_{args.remarks}"
